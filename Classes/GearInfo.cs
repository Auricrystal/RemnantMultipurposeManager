...
namespace RemnantMultipurposeManager
{
    public class GearInfo
    {
        ...
        public static List<InventoryItem> Items
        {
            ...
            {
                if (items.Count == 0) { 
                    items = JsonConvert.DeserializeObject<List<InventoryItem>>(File.ReadAllText(@"C:\Users\AuriCrystal\Documents\VisualProjects\RemnantMultipurposeManager\Resources\RemnantItemIndex.txt"));
                }
                return items;
            }
        }
